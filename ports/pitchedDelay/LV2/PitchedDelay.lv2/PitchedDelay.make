...
ifeq ($(CONFIG),Release)
  ...
  OUTDIR := ../../../bin/lv2/PitchedDelay.lv2
...
OBJECTS := \
	...
	$(OBJDIR)/delaytabdsp.o \
	$(OBJDIR)/pitcheddelay.o \
	$(OBJDIR)/simpledetune.o \
	$(OBJDIR)/BandLimit.o \
	$(OBJDIR)/DelayGraph.o \
	$(OBJDIR)/pitcheddelaytab.o \
...
$(OUTDIR)/$(TARGET): $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking PitchedDelay.lv2/PitchedDelay
	-@$(CMD_MKBINDIR)
	-@$(CMD_MKLIBDIR)
	-@$(CMD_MKOUTDIR)
	@$(BLDCMD)
...
clean:
	@echo Cleaning PitchedDelay.lv2/PitchedDelay
ifeq ($(MKDIR_TYPE),posix)
	-@rm -f $(OUTDIR)/$(TARGET)
	-@rm -rf $(OBJDIR)
else
...
$(OBJDIR)/delaytabdsp.o: ../source/dsp/delaytabdsp.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"

$(OBJDIR)/pitcheddelay.o: ../source/dsp/pitcheddelay.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"

$(OBJDIR)/simpledetune.o: ../source/dsp/simpledetune.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"

$(OBJDIR)/BandLimit.o: ../source/dsp/BandLimit.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"

$(OBJDIR)/DelayGraph.o: ../source/gui/DelayGraph.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"

$(OBJDIR)/pitcheddelaytab.o: ../source/gui/pitcheddelaytab.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o "$@" -c "$<"
