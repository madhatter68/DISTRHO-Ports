...
ifeq ($(CONFIG),Release)
  ...
  OUTDIR := ../../../bin/lv2/TAL-Reverb-2.lv2
...
$(OUTDIR)/$(TARGET): $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking TAL-Reverb-2.lv2/TAL-Reverb-2
	-@$(CMD_MKBINDIR)
	-@$(CMD_MKLIBDIR)
	-@$(CMD_MKOUTDIR)
	@$(BLDCMD)
...
clean:
	@echo Cleaning TAL-Reverb-2.lv2/TAL-Reverb-2
ifeq ($(MKDIR_TYPE),posix)
	-@rm -f $(OUTDIR)/$(TARGET)
	-@rm -rf $(OBJDIR)
else
