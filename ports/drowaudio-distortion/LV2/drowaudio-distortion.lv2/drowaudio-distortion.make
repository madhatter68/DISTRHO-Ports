...
ifeq ($(CONFIG),Release)
  ...
  OUTDIR := ../../../bin/lv2/drowaudio-distortion.lv2
...
$(OUTDIR)/$(TARGET): $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking drowaudio-distortion.lv2/drowaudio-distortion
	-@$(CMD_MKBINDIR)
	-@$(CMD_MKLIBDIR)
	-@$(CMD_MKOUTDIR)
	@$(BLDCMD)
...
clean:
	@echo Cleaning drowaudio-distortion.lv2/drowaudio-distortion
ifeq ($(MKDIR_TYPE),posix)
	-@rm -f $(OUTDIR)/$(TARGET)
	-@rm -rf $(OBJDIR)
else
